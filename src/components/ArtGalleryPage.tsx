...
export const ArtGalleryPage: React.FC<ArtGalleryPageProps> = ({
  ...
  return (
    ...
    >
          ...
          <div className="relative">
            ...
            >
                ...
                {selectedCharacter ? (
                  <>
                    <img
                      ...
                      className="w-7 h-7 sm:w-8 sm:h-8 rounded-full object-cover border-2 border-amber-400 shrink-0"
                      referrerPolicy="no-referrer"
                    />
                  ...
                  <>
                    ...
                    <span className="text-xs sm:text-sm font-bold text-slate-400 dark:text-purple-300/60 truncate">
                      Bấm để chọn anh chồng cần xem tranh...
                    </span>
                  </>
                )}
              </div>
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                {selectedCharacterId && (
                  <span className="px-2 py-0.5 rounded-full text-[9px] sm:text-[10px] font-black bg-amber-400/20 text-amber-800 dark:text-amber-200 border border-amber-300/50">
                    Đang lọc
                  </span>
                )}
                <ChevronDown
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.div
                  ...
                  className={`absolute top-full left-0 right-0 mt-2 rounded-2xl border-2 shadow-2xl z-50 max-h-72 overflow-y-auto p-2 backdrop-blur-xl ${
                    isHellMode
      ...
      {/* 8. LIGHTBOX / HIGH-RES ARTWORK INSPECTION MODAL (WITH STRICT ANTI-DOWNLOAD SHIELD) */}
      <AnimatePresence>
